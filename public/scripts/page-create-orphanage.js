//create map
const map = L.map('mapid').setView([-22.2135645,-49.9500768,], 15);
...
function addPhotoField() {
    ...
    // realizar o clone da útima imagem add
    const newFieldContainer = fieldsContainer[fieldsContainer.length - 1].cloneNode(true)

    // verificar se está vazio ou nõ
...
function toggleSelect(event) {
    ...
    // colocar classe active no botao clicado
